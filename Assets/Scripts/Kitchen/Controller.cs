...
namespace Kitchen{
	public class Controller : MonoBehaviour {
		...
		public void StartCooking(Character.Controller control, string mealName)
		{
		...
		{
			Character.Controller owner = meal.owner;
		...
		void GoToNode(GameObject destination, Character.Controller control)
		{
		...
		void Update()
		{
			foreach (GameObject node in kitchenNodes)
			{
				...
				if (trigger.isActive)
				{
					Character.Controller control = trigger.characterInTrigger;
